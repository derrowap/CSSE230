	...
	class Panel extends JPanel {
		...
		public void paintComponent(Graphics comp) {
			...
			if (b.root != null) {
				...
				Node n = new Node(this.getWidth() / 2 - 12.5, 25,
						(Integer) root.getElement(), root.getHeight());//getElement()
				n.drawOn(comp2D);
		...
		public void drawRec(Node n, AVLTree.BinaryNode par,
			...
			if (par.getLeftChild() != null) {
				...
				n.translate(x - TRANSX, y + TRANSY, (Integer) apar.getElement(), apar.getHeight()); // getElement
				n.drawOn(comp2D);
			...
			if (par.getRightChild() != null) {
				...
				n.translate(x + TRANSX, y + TRANSY, (Integer) bpar.getElement(), bpar.getHeight()); // getElement
				n.drawOn(comp2D);
